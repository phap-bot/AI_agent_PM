...
class Settings:
    ...
    researcher_model: str = field(default_factory=lambda: os.getenv("OLLAMA_RESEARCHER_MODEL", os.getenv("OLLAMA_REASONING_MODEL", "qwen2.5:3b")))
    embedding_model: str = field(default_factory=lambda: os.getenv("OLLAMA_EMBED_MODEL", "qwen-embed:latest"))
    ollama_timeout: int = field(default_factory=lambda: int(os.getenv("OLLAMA_TIMEOUT", "600")))
    ...
    context_collection: str = field(default_factory=lambda: os.getenv("QDRANT_COLLECTION", "ai_scrum_master_context"))
    rag_backend: str = field(default_factory=lambda: os.getenv("RAG_BACKEND", "langchain"))
    rag_fallback_to_direct_qdrant: bool = field(default_factory=lambda: _bool_env("RAG_FALLBACK_TO_DIRECT_QDRANT", True))
    mongodb_uri: str = field(default_factory=lambda: os.getenv("MONGODB_URI", "mongodb://localhost:27017"))
    mongodb_db_name: str = field(default_factory=lambda: os.getenv("MONGODB_DB_NAME", "ai_scrum_master"))
    ...
    slack_dev_channel_id: str = field(default_factory=lambda: os.getenv("SLACK_DEV_CHANNEL_ID", ""))
    slack_qa_channel_id: str = field(default_factory=lambda: os.getenv("SLACK_QA_CHANNEL_ID", ""))
