      ...
      <div className="relative overflow-hidden rounded-[22px] border border-slate-200 bg-white text-slate-950">
        <div className="flex items-center justify-between border-b border-slate-200 px-5 py-4">
          <div className="flex items-center gap-2">
            <span className="grid h-7 w-7 place-items-center rounded-lg bg-blue-50 text-sm font-black text-blue-600">S</span>
            <p className="text-sm font-extrabold">SprintForge AI</p>
          </div>
        ...
        <div className="grid min-h-[430px] sm:grid-cols-[150px_1fr]">
          ...
          <div className="p-5">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-xl font-black tracking-[-0.03em]">Pipeline</p>
  ...
  return (
    <div className="min-h-screen overflow-hidden bg-[#f8fbff] text-slate-950">
      ...
      <header className="relative z-10 mx-auto flex max-w-7xl items-center justify-between px-6 py-6 lg:px-8">
        <button onClick={onEnterApp} className="flex items-center gap-3 text-left" aria-label="Open SprintForge AI app">
          ...
          <span className="text-lg font-extrabold tracking-tight">SprintForge AI</span>
        </button>
      ...
      <main className="relative z-10">
        <section id="product" className="mx-auto grid max-w-7xl items-center gap-14 px-6 pb-24 pt-14 lg:grid-cols-[0.95fr_1.05fr] lg:px-8 lg:pb-32 lg:pt-20">
          <div>
            <h1 className="max-w-4xl text-5xl font-black tracking-[-0.055em] text-slate-950 sm:text-6xl">
        ...
        <section id="workflow" className="border-y border-slate-200/80 bg-white/72 py-20 backdrop-blur">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto max-w-3xl text-center">
              <h2 className="text-4xl font-black tracking-[-0.04em] text-slate-950">A workflow built for agile teams</h2>
        ...
        <section className="mx-auto max-w-7xl px-6 py-24 lg:px-8">
          <div className="mx-auto mb-12 max-w-3xl text-center">
            <h2 className="text-4xl font-black tracking-[-0.04em] text-slate-950">Everything you need to deliver better sprints</h2>
          </div>
        ...
        <section className="mx-auto max-w-7xl px-6 pb-20 lg:px-8">
          <div className="grid items-center gap-10 rounded-[28px] border border-slate-200 bg-white/88 p-8 shadow-sm md:grid-cols-[0.8fr_1fr_0.9fr] md:p-10">
            ...
            <div>
              <h2 className="text-3xl font-black tracking-[-0.04em] text-slate-950">Local-first. Private by design.</h2>
              <p className="mt-4 text-base leading-7 text-slate-600">
                SprintForge AI runs locally in your environment. Your data never leaves your network. You stay in control.
              </p>
            </div>
        ...
        <section id="pricing" className="mx-auto max-w-7xl px-6 pb-24 lg:px-8">
          <div className="mx-auto mb-10 max-w-3xl text-center">
            <h2 className="text-4xl font-black tracking-[-0.04em] text-slate-950">Simple pricing. Start building today.</h2>
      ...
      <footer id="docs" className="relative z-10 bg-slate-950 text-white">
        <div className="mx-auto grid max-w-7xl gap-10 px-6 py-12 text-sm lg:grid-cols-[1.2fr_1fr_1fr_1fr] lg:px-8">
          <div>
            <p className="text-lg font-black">SprintForge AI</p>
