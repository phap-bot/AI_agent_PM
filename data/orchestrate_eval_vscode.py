...
DATA_FILE = Path(__file__).parent / "vscode_closed_dataset.json"
PM_OUTPUT_FILE = Path(__file__).parent / "vscode_pm_prediction.json"
GEMINI_OUTPUT_FILE = Path(__file__).parent / "vscode_gt_prediction.json"
...
Example: {"type": "feature", "domain": "backend", "complexity": "medium", "team": "be"}"""
    ...
    print(report)
    with open(Path(__file__).parent / "benchmark_report_vscode.txt", "w", encoding="utf-8") as f:
        f.write(report)
